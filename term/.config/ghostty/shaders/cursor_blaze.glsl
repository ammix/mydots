...
const vec4 TRAIL_COLOR = vec4(0.98, 0.70, 0.53, 1.0); // Catppuccin Mocha Peach
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.80, 0.65, 0.97, 1.0); // Catppuccin Mocha Mauve
const float DURATION = .8;
const float OPACITY = .12;
